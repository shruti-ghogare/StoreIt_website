            ...
            if(isset($_SESSION["username"]) && isset($_SESSION["password"])){
                ...
                <div class="contentwrapper">
                    ...
                    if(isset($_GET["filestorage"])){
                        ...
                        ?>
                        <h1>Home</h1>
                        <p style="font-weight:bold;font-size:50px;text-align:center">UNLIMITED ONLINE STORAGE PLATFORM</p>
                        <p style="font-weight:bold;font-size:50px;text-align:center;background-color:Gray;">StoreIt</p>
                        <div><img src="storage.png" alt="storage"style="width:400px;height:400px;"class="center"></div>
                        <?php
                    }
                ...
                ?>
                <div align="left" style="padding: 30px;"class="center">
                    <h1 class="center">Please login to access</h1>
                    <form method="post">
                        <div class="center">
                        ...
                        <div class="center">
                            ...
                            <input type="password" name="password" placeholder="Enter admin">
                        </div>
                        <div class="center">
